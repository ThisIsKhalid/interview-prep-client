        ...
        <section className='container mx-auto py-20'>
            <div className='grid grid-cols-4'>
                <div className='text-center'>
                    <h1 className='text-5xl text-gray-800'>4.5</h1>
                    <p className='text-xl text-gray-700 font-medium'>80k Reviews</p>
                </div>
                <div className='border-l-2 border-gray-700 text-center'>
                    <h1 className='text-5xl text-gray-800'>30M</h1>
                    <p className='text-xl text-gray-700 font-medium'>Enrollments</p>
                </div>
                <div className='border-l-2 border-gray-700 text-center'>
                    <h1 className='text-5xl text-gray-800'>2M+</h1>
                    <p className='text-xl text-gray-700 font-medium'>Learners</p>
                </div>
                <div className='border-l-2 border-gray-700 text-center'>
                    <h1 className='text-5xl text-gray-800'>1K+</h1>
